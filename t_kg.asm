...
; ============================================================================ 
    ...
    MOV AX, 5000      ; Parte entera de las toneladas
    MOV BX, 50        ; Parte decimal de las toneladas (centésimas)
    MOV CX, 100       ; Factor de multiplicación para manejar los decimales (100)

    ; Multiplicar AX (toneladas enteras) por CX (100) para convertir en centésimas
