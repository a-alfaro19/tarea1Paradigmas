...
KILOGRAMOS_A_LIBRAS proc near
    ...
    MOV CX, 50 
    CALL Div32x16  ; Factor de conversion  1 kg = 2.2046 lb
...
LIBRAS_A_KILOGRAMOS proc near
    ...
    Positivo_lb:  ;Factor de conversion 1libra = 0,4536 kg
...
Positivo_km:  
    ...
    ; Dividir entre 346 (DX:AX /346) ya que 1 kilometro = 0.62137 millas
    MOV CX, 346     
    CALL Div32x16  
...
Positivo_millas:  
    ...
    MOV CX, 346       ; Factor de conversion 1milla = 1.6093km
    CALL Mul32x16     
