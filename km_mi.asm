...
; ============================================================================ 
    ...
    MOV AX, 5000      ; Parte entera de los kilómetros
    MOV BX, 50        ; Parte decimal de los kilómetros (centésimas)
    MOV CX, 100       ; Factor de multiplicación para manejar los decimales (100)

    ; Multiplicar AX (kilómetros enteros) por CX (100) para convertir en centésimas
