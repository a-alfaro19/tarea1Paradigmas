...
; ============================================================================ 
    ...
    MOV AX, 329      ; Parte entera de los cm
    MOV BX, 17       ; Parte decimal de los cm (centésimas)
    MOV CX, 100      ; Factor para multiplicar y obtener precisión

    ; Multiplicar AX (centímetros enteros) por CX (100) para convertir en centésimas
    ...
    JNS sumar_bxc     ; Si es positivo, saltar a suma
